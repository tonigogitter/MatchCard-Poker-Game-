...
//Used in MatchPlayer to create a MatchPlayer's hand which is an ordered list of MatchCards, to sort by less than of Clubs, Spades, Hearts, Diamonds and rank least to greatest.
template <class T, class Order = IsLess>//Changed
class OrderedList {
public:
